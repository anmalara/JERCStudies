...
jetID(jetID_), TopjetID(TopjetID_), muoIDcleaning(muoID_), eleIDcleaning(eleID_) {
  ...
  strings["genjetLabel"]   = bools["isTopJet"]? (bools["isHOTVR"]? "hotvrGen" : "gentopjets") : "genjets";
  strings["jet_coll"]      = bools["isTopJet"]? "AK8" : "AK4"; strings["jet_coll"] += (FindInString("Puppi",strings["jetLabel"])+FindInString("puppi",strings["jetLabel"])) ? "PFPuppi": "PFchs";
